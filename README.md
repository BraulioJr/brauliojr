...
<section>
  ...
  <h2 style="text-align: left;">Linguagens e Ferramentas</h2>
...
<!-- Portfólio -->
<section id="portfolio" style="text-align: left;">
  <h2>Portfólio</h2>

  <h3>Programação e Projetos</h3>
  <ul>
    <li>Programação em Python para análise de dados</li>
    <li>Processo de Gerenciamento de Dados (ETL - Extrair, Transformar e Carregar)</li>
  ...
  <ul>
    ...
    <li>Refatorado Proj. 2022 – Interface e UI (Privado)</li>
    <li>Refatorado Proj. 2021 – Banco de Dados (Privado)</li>
    <li>Refatorado Proj. 2020 – Primeiro Repositório no GitHub</li>
  </ul>
</section>
...
<section style="text-align:CENTER; margin-top: 40px;">
  ...
  <a href="https://open.spotify.com/user/31smb24pscew3akwdhp2dbpyluni" target="_blank" rel="noopener noreferrer">
    <img 
      src="https://img.shields.io/badge/🎧_ Modo: Crescimento Profissional_[ATIVADO]-1DB954?style=for-the-badge&logo=spotify&logoColor=white" 
      alt="Ouça no Spotify" 
